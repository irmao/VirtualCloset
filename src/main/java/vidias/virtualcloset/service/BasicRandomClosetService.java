...
@Service
public class BasicRandomClosetService extends RandomClosetService {
    /**
    ...
    public Clothing getRandomClothing(Random random, ArrayList<Clothing> clothes,
            Set<BodyPosition> occupiedBodyPositions, Closet alreadyChosenClothes) throws RandomGeneratorException {
