CREATE TABLE IF NOT EXISTS VC_CLOSET (
  ID INT NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS VC_CLOSET_SEQ INCREMENT 1;

CREATE TABLE IF NOT EXISTS VC_CLOSET_CLOTHING (
  ID INT NOT NULL,
  ...
  CREATE SEQUENCE IF NOT EXISTS VC_CLOSET_CLOTHING_SEQ INCREMENT 1;
